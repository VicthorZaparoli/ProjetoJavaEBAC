...
public class App {
	...
	public static void main(String args[]) {
		...
		while (!isOpcaoValida(opcao)) {
			...
			opcao = JOptionPane.showInputDialog(null,
					"Opção inválida. Digite 1 para cadastro, 2 para consulta, 3 para exclusão, 4 para alterar ou 5 para sair",
					"Green dinner", JOptionPane.INFORMATION_MESSAGE);
		}
		...
		while (isOpcaoValida(opcao)) {
			...
			if (isOpcaoSair(opcao)) {
				...
				String dados = JOptionPane.showInputDialog(null, "Atualização", JOptionPane.INFORMATION_MESSAGE);
				atualizar(dados);
			}
	...
	private static void consultar(String dados) {
		...
		if(cliente != null) {
			JOptionPane.showMessageDialog(null, "Cliente encotrado com sucess:" + cliente, "Consulta", JOptionPane.INFORMATION_MESSAGE);
		} else {
	...
	private static void cadastrar(String dados) {
		...
		if (isCadastrado) {
			...
			JOptionPane.showMessageDialog(null, "Cliente já se encontrada cadastrado", "Erro",
					JOptionPane.INFORMATION_MESSAGE);
		}
